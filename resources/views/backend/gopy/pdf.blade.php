            ...
            <table border="0" align="center" cellspacing="0">
                ...
                <table border="1" align="center" cellpadding="5" style="width:80%">
                    ...
                    <tr>
                        ...
                        <th style="width:15%">Mã góp ý</th>
                        <th style="width:15%">Thời gian góp ý</th>
                        <th style="width:15%">Nội dung góp ý</th>
                    ...
                    <tr>
                        ...
                        <td align="left">{{ $gy->gy_ma }}</td>
                        <td align="left">{{ $gy->gy_thoiGian }}</td>
                        <td align="left">{{ $gy->gy_noiDung }}</td>
                        <td align="left">{{ $gy->khachHang->kh_hoTen }}</td>
                        <td align="left">{{ $gy->sanPham->sp_ten }}</td>
                        <td align="left">{{ $gy->gy_trangThai }}</td>
                    </tr>
                    @if (($loop->index + 1) % 5 == 0)
                </table>
